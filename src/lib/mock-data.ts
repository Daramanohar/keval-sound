export interface Track {
  ...
  artist: string;
  audioUrl?: string;
  /** Path to a plain-text lyrics file under /public/lyrics/. Fetched on demand. */
  lyricsUrl?: string;
  genre: string;
  mood: string;
  bpm: number;
...
// ─── Demo Pack Songs ──────────────────────────────────────────────────────
// Real audio + lyrics from the 6 BOLLY V1 demo packs, copied into
// public/audio/<packId>/ and public/lyrics/<packId>/ by
// scripts/import-demo-packs.mjs.
//
// Generated by the import script — re-run to regenerate after adding new
// demo packs. MDATA (metadata) files from the source are intentionally NOT
// referenced anywhere — internal-only per spec.

const demoPackSongs: Record<string, {
  artist: string; genre: string; mood: string;
  songs: { slug: string; title: string; audioUrl: string; lyricsUrl: string }[];
}> = {
  "pack-27": {
    artist: "Mumbai Floor",
    genre: "HINDI/BOLLYWOOD",
    ...
    songs: [
      ...
      { slug: "raat-ka-jadoo-night-s-spell", title: "Raat Ka Jadoo (Night's Spell)", audioUrl: "/audio/pack-27/raat-ka-jadoo-night-s-spell.mp3", lyricsUrl: "/lyrics/pack-27/raat-ka-jadoo-night-s-spell.txt" },
      { slug: "raat-ki-awaaz", title: "Raat Ki Awaaz", audioUrl: "/audio/pack-27/raat-ki-awaaz.mp3", lyricsUrl: "/lyrics/pack-27/raat-ki-awaaz.txt" },
      { slug: "safar-e-dil", title: "Safar-e-Dil", audioUrl: "/audio/pack-27/safar-e-dil.mp3", lyricsUrl: "/lyrics/pack-27/safar-e-dil.txt" },
    ],
  },
  "pack-24": {
    artist: "Bombay Wires",
    ...
    songs: [
      ...
      { slug: "dhoondte-rahe", title: "Dhoondte Rahe", audioUrl: "/audio/pack-24/dhoondte-rahe.mp3", lyricsUrl: "/lyrics/pack-24/dhoondte-rahe.txt" },
      { slug: "jadoo", title: "Jadoo", audioUrl: "/audio/pack-24/jadoo.mp3", lyricsUrl: "/lyrics/pack-24/jadoo.txt" },
      { slug: "raat-ka-safar", title: "Raat Ka Safar", audioUrl: "/audio/pack-24/raat-ka-safar.mp3", lyricsUrl: "/lyrics/pack-24/raat-ka-safar.txt" },
      { slug: "raat-ke-sayein", title: "Raat Ke Sayein", audioUrl: "/audio/pack-24/raat-ke-sayein.mp3", lyricsUrl: "/lyrics/pack-24/raat-ke-sayein.txt" },
      { slug: "raatein-bechaini", title: "Raatein Bechaini", audioUrl: "/audio/pack-24/raatein-bechaini.mp3", lyricsUrl: "/lyrics/pack-24/raatein-bechaini.txt" },
      { slug: "raatein-mein-kho-jayein", title: "Raatein Mein Kho Jayein", audioUrl: "/audio/pack-24/raatein-mein-kho-jayein.mp3", lyricsUrl: "/lyrics/pack-24/raatein-mein-kho-jayein.txt" },
      { slug: "raaz-ke-peeche", title: "Raaz Ke Peeche", audioUrl: "/audio/pack-24/raaz-ke-peeche.mp3", lyricsUrl: "/lyrics/pack-24/raaz-ke-peeche.txt" },
      { slug: "shadow", title: "Shadow", audioUrl: "/audio/pack-24/shadow.mp3", lyricsUrl: "/lyrics/pack-24/shadow.txt" },
      { slug: "tere-saaye-mein", title: "Tere Saaye Mein", audioUrl: "/audio/pack-24/tere-saaye-mein.mp3", lyricsUrl: "/lyrics/pack-24/tere-saaye-mein.txt" },
      { slug: "the-sound-of-space", title: "The Sound of Space", audioUrl: "/audio/pack-24/the-sound-of-space.mp3", lyricsUrl: "/lyrics/pack-24/the-sound-of-space.txt" },
      { slug: "udaan-ke-par", title: "Udaan Ke Par", audioUrl: "/audio/pack-24/udaan-ke-par.mp3", lyricsUrl: "/lyrics/pack-24/udaan-ke-par.txt" },
      { slug: "zindagi-ka-jashn", title: "Zindagi Ka Jashn", audioUrl: "/audio/pack-24/zindagi-ka-jashn.mp3", lyricsUrl: "/lyrics/pack-24/zindagi-ka-jashn.txt" },
    ],
  },
  "pack-29": {
    artist: "Gully Beats",
    ...
    songs: [
      ...
      { slug: "dhun-ka-junoon", title: "Dhun Ka Junoon", audioUrl: "/audio/pack-29/dhun-ka-junoon.mp3", lyricsUrl: "/lyrics/pack-29/dhun-ka-junoon.txt" },
      { slug: "echoes-of-the-bazaar", title: "Echoes of the Bazaar", audioUrl: "/audio/pack-29/echoes-of-the-bazaar.mp3", lyricsUrl: "/lyrics/pack-29/echoes-of-the-bazaar.txt" },
      { slug: "udaan", title: "Udaan", audioUrl: "/audio/pack-29/udaan.mp3", lyricsUrl: "/lyrics/pack-29/udaan.txt" },
      { slug: "vintage-hindi-sample-dreams", title: "Vintage Hindi Sample Dreams", audioUrl: "/audio/pack-29/vintage-hindi-sample-dreams.mp3", lyricsUrl: "/lyrics/pack-29/vintage-hindi-sample-dreams.txt" },
    ],
  },
  "pack-28": {
    artist: "Studio 47",
    ...
    songs: [
      ...
      { slug: "raat-ka", title: "Raat Ka", audioUrl: "/audio/pack-28/raat-ka.mp3", lyricsUrl: "/lyrics/pack-28/raat-ka.txt" },
      { slug: "sapno-ki-udaan", title: "Sapno Ki Udaan", audioUrl: "/audio/pack-28/sapno-ki-udaan.mp3", lyricsUrl: "/lyrics/pack-28/sapno-ki-udaan.txt" },
    ],
  },
  "pack-26": {
    artist: "Dilli Riots",
    ...
    songs: [
      ...
      { slug: "shadows-of-the-storm", title: "Shadows of the Storm", audioUrl: "/audio/pack-26/shadows-of-the-storm.mp3", lyricsUrl: "/lyrics/pack-26/shadows-of-the-storm.txt" },
      { slug: "storm", title: "Storm", audioUrl: "/audio/pack-26/storm.mp3", lyricsUrl: "/lyrics/pack-26/storm.txt" },
      { slug: "tute-dil-ke-sayein", title: "Tute Dil Ke Sayein", audioUrl: "/audio/pack-26/tute-dil-ke-sayein.mp3", lyricsUrl: "/lyrics/pack-26/tute-dil-ke-sayein.txt" },
      { slug: "unspoken-words", title: "Unspoken Words", audioUrl: "/audio/pack-26/unspoken-words.mp3", lyricsUrl: "/lyrics/pack-26/unspoken-words.txt" },
    ],
  },
  "pack-25": {
    ...
    songs: [
      ...
      { slug: "dil-ki-dastaan", title: "Dil Ki Dastaan", audioUrl: "/audio/pack-25/dil-ki-dastaan.mp3", lyricsUrl: "/lyrics/pack-25/dil-ki-dastaan.txt" },
      { slug: "dil-ki-goonj", title: "Dil Ki Goonj", audioUrl: "/audio/pack-25/dil-ki-goonj.mp3", lyricsUrl: "/lyrics/pack-25/dil-ki-goonj.txt" },
      { slug: "rishton-ki-parchhai", title: "Rishton Ki Parchhai", audioUrl: "/audio/pack-25/rishton-ki-parchhai.mp3", lyricsUrl: "/lyrics/pack-25/rishton-ki-parchhai.txt" },
      { slug: "sapno-ki-duniya", title: "Sapno Ki Duniya", audioUrl: "/audio/pack-25/sapno-ki-duniya.mp3", lyricsUrl: "/lyrics/pack-25/sapno-ki-duniya.txt" },
      { slug: "yaadein", title: "Yaadein", audioUrl: "/audio/pack-25/yaadein.mp3", lyricsUrl: "/lyrics/pack-25/yaadein.txt" },
    ],
  },
};
...
function buildDemoPackTracks(packId: string, packCoverUrl: string, packTags: string[]): Track[] {
  const meta = demoPackSongs[packId];
  if (!meta) return [];
  return meta.songs.map((song, i) => ({
    id: `${packId}-${song.slug}`,
    title: song.title,
    artist: meta.artist,
    ...
    genre: meta.genre,
    mood: meta.mood,
    bpm: 90 + ((i * 13) % 70), // deterministic pseudo-variety, 90–160
    key: KEY_ROTATION[i % KEY_ROTATION.length],
    duration: 220, // placeholder; real duration loads from <audio> metadata at play time
    price: 99,
    coverUrl: packCoverUrl,
    waveform: generateWaveform(`${packId}-${song.slug}`),
    tags: packTags,
    isExclusive: true,
    isTrending: i < 2,
    isSellingFast: i === 0,
...
const packDefs: PackDef[] = [
  ...
  { n: 9,  title: "Reggae",                     category: "Culture",    count: 40, price: 11999, origPrice: 19999, desc: "40 Reggae tracks with island grooves, dub textures, and breezy coastal energy.", tags: ["reggae", "dub", "tropical", "island"], featured: false },
  ...
  { n: 54, title: "Fitness & Workout",          category: "Occasion",   count: 50, price: 14999, origPrice: 24999, desc: "50 high-energy Fitness and Workout tracks to push every rep and stay in the zone.", tags: ["fitness", "workout", "gym", "energy"], featured: false },
...
export const packs: Pack[] = packDefs.map((d) => {
  const id = `pack-${d.n}`;
  const coverUrl = `/packs/pack-${d.n}.png`;
  // If a demo pack has real audio + lyrics for this id, use those tracks.
  // Otherwise fall back to placeholder expansion. The 6 BOLLY V1 demos
  // currently cover pack-24..pack-29 with fewer-than-full song counts —
  // that's intentional for testing.
  const demoTracks = buildDemoPackTracks(id, coverUrl, d.tags);
  const tracks = demoTracks.length > 0 ? demoTracks : expandPackTracks(id, d.count);
  return {
    id,
    title: d.title,
    description: d.desc,
